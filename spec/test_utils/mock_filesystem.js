...
export function mockFileSystemDirectoryHandle(directoryName) {
    ...
    this.queryPermission = () => mockResolvePromise(this.permission);
    this.requestPermission = () => mockResolvePromise(this.permission);
    this.getFileHandle = (filename, config) => {
        return mockResolvePromise(new mockFileSystemFileHandle(directoryName + "/" + filename, config));
    }
    this.getDirectoryHandle = (dirName) => {
        return mockResolvePromise(new mockFileSystemDirectoryHandle(directoryName + "/" + dirName))
    }
}
