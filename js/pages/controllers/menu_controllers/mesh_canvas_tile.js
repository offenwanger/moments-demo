...
export function MeshCanvasTile(id, label, size, color = null, dynamic = false) {
    ...
    this.getCtx = () => mCtx;
    this.getHeight = () => mCanvas.height;
    this.getWidth = () => mCanvas.width;
